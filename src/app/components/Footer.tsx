    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.col}>
          ...
          <p className={styles.sectors}>
            ...
            Salud · Educación · Logística · Agroindustria · Financiero · Energía
            · Telecomunicaciones
          </p>
        </div>
      </div>
      ...
      <div className={styles.legal}>
        ...
        <span className={styles.note}>
          ...
          Consejo Superior de la Judicatura de Colombia. Los servicios jurídicos
          son prestados por abogados titulados e inscritos.
        </span>
      </div>
    </footer>
  );
